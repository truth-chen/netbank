		...
		<table>
			<tr>
				...
				<td width="80"><s:if test="pager.curPage>1">
						<A href='${pageContext.request.contextPath}/transaction/list?pager.curPage=1'>首页</A>&nbsp;&nbsp;
				<A
							href='${pageContext.request.contextPath}/transaction/list?pager.curPage=${pager.curPage-1 }'>上一页</A>
					</s:if>
				</td>
				<td width="80"><s:if test="pager.curPage < pager.pageCount">
						<A
							href='${pageContext.request.contextPath}/transaction/list?pager.curPage=${pager.curPage+1}'>下一页</A>&nbsp;&nbsp;
				<A
							href='${pageContext.request.contextPath}/transaction/list?pager.curPage=${pager.pageCount }'>尾页</A>
					</s:if>
				</td>
